...
public class cubeHELIX_X extends Sprite
{
	...
	public function cubeHELIX_X(viewportWidth:Number = 720, viewportHeight:Number = 576, scaleToStage:Boolean = false, interactive:Boolean = false, cameraType:String = "CAMERA3D") 
	{
		...
		//materials
		var flatShadeMaterial:FlatShadeMaterial = new FlatShadeMaterial(new PointLight3D(), 0xfd01df, 0x01dffd);
	...
	{
		helixShaded.yaw(2);
/*		if(helixShaded.z > -10000){
			helixShaded.z -= 2;
		}else{
			helixShaded.z = 10000;
		}*/
		helixWireFr.yaw(2);
/*		if(helixWireFr.z > -10000){
			helixWireFr.z -= 2;
		}else{
			helixWireFr.z = 10000;
		}*/
