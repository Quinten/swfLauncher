package 
{
	 ...
	 */
	public class cubesnake extends MovieClip 
	{
		...
		public var nCubeParts:int = 600;		
		public var cubeSize:int = 220;
		...
		public var xBoundsA:Number = -3000;
		public var xBoundsB:Number = 3000;
		public var yBoundsA:Number = -3000;
		public var yBoundsB:Number = 3000;
		public var zBoundsA:Number = -3000;
		public var zBoundsB:Number = 3000;
		...
		public function cubesnake():void 
		{	
...
/*			for (var c:int = 0; c < nCubeDrops; c++ )
		...
		public function animationLoop():void
		{
			...
			var camera_step:Number = (camera_float) ? 12 : -12;
